...
std::expected<domain::AuthenticatedManifest, domain::ManifestAuthenticationError> ManifestAuthenticator::Authenticate(const std::span<const std::uint8_t> envelope) const {
