...
constexpr std::string_view SHARE_FORMAT = "{:.1f}%";
constexpr std::string_view TRACKER_FORMAT = "trackers {} replies {} peers";
constexpr std::string_view TRACKER_SILENT = "trackers no reply yet";
constexpr std::string_view TRACKER_UNAVAILABLE_FORMAT = "{} endpoints unavailable";
