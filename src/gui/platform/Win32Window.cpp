...
bool Win32Window::Create(const std::wstring& title, std::uint32_t width, std::uint32_t height) {
...
LRESULT Win32Window::HitTest_(HWND window, LPARAM lparam) {
...
LRESULT CALLBACK Win32Window::RouteMessage_(HWND window, UINT message, WPARAM wparam, LPARAM lparam) {
...
LRESULT Win32Window::HandleMessage_(HWND window, UINT message, WPARAM wparam, LPARAM lparam) {
