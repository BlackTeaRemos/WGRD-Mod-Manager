...
std::size_t FastCdcChunker::NextBoundary(std::span<const std::byte> data) const noexcept {
...
std::vector<domain::ChunkSpan> FastCdcChunker::Split(std::span<const std::byte> data) const {
