...
public:
    ...
    static std::expected<FixedBytes, FixedBytesError> FromHex(std::string_view text) {
...
private:
    static constexpr std::expected<std::uint8_t, FixedBytesError> DecodeNibble_(char character) {
